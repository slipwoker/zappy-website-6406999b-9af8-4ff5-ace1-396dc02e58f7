document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      var parent = field.closest('.form-group') || field.parentNode;
      var existing = parent.querySelector('.form-error-message');
      if (existing) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Ds Jersey משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6406999b-9af8-4ff5-ace1-396dc02e58f7',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6406999b-9af8-4ff5-ace1-396dc02e58f7';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6406999b-9af8-4ff5-ace1-396dc02e58f7';
